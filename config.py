...
DEVS = list(map(int, os.getenv("DEVS", "7546117130").split()))

API_ID = int(os.getenv("API_ID", "20607074"))

API_HASH = os.getenv("API_HASH", "f5639cb2a94b785afc60800f351ec802")

BOT_TOKEN = os.getenv("BOT_TOKEN", "8250085665:AAFWIHNKdvTZP_uAeZQvQxeNJ7VLsdArWy4")

OWNER_ID = int(os.getenv("OWNER_ID", "7769449593"))
